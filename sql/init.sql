...
(5,  '系统管理员',         'sys-manager',         '跨机构全局管理，除系统配置外拥有所有菜单权限',       1, 'all',       1),
-- 业务线角色（经销商侧）
(2,  '业务员',             'salesman',            '负责订单开拓、客户维护，只能看自己关联医院的数据',   1, 'hospitals', 1),
(3,  '业务管理员（部门级）','sale-manager-dept',   '管理本部门业务员及订单',                           1, 'dept',      1),
(4,  '业务管理员（机构级）','sale-manager-org',    '管理本经销商机构所有部门',                         1, 'org',       1),
-- 设计线角色（企业内部）
(6,  '设计师',             'designer',            '处理分配给自己的设计工单',                         1, 'self',      1),
(7,  '设计师管理员',       'designer-manager',    '工单分配、审核、统计，菜单权限同设计师',             1, 'all',       1),
-- 生产线角色（企业内部）
(8,  '生产员',             'production-worker',   '执行生产任务，可见全部数据',                       1, 'all',       1),
(9,  '生产管理员',         'production-manager',  '生产任务分配、进度管理，菜单权限同生产员',           1, 'all',       1),
-- 质检线角色（企业内部）
(10, '质检员',             'qc-inspector',        '质检执行，可见全部数据',                           1, 'all',       1);
...
-- 业务管理员（部门级）（role_id=3）
-- 菜单：数据概览、订单管理、资料管理、个人中心
-- 按钮：订单管理页（订单列表Tab/审核列表Tab/批量导出/查看详情/影像调阅/修改历史/审核通过/审核驳回/审核查看）
INSERT INTO sys_role_resource (role_id, resource_id) VALUES
(3, 1), (3, 2), (3, 6), (3, 10),
(3, 101),
(3, 1102), (3, 1103), (3, 1106), (3, 1107), (3, 1108),
(3, 1110), (3, 1112), (3, 1113), (3, 1117);
...
(4, 1), (4, 2), (4, 6), (4, 10),
(4, 101),
(4, 1102), (4, 1103), (4, 1106), (4, 1107), (4, 1108),
(4, 1110), (4, 1112), (4, 1113), (4, 1117);

-- 系统管理员（role_id=5）
-- 菜单：除系统配置（字典/参数/日志/备份）外所有菜单
-- 按钮：订单管理页（订单列表Tab/审核列表Tab/批量导出/查看详情/影像调阅/修改历史/审核通过/审核驳回/审核查看）
--       工单页（导出记录/查看详情/图纸指令单预览/影像在线预览/生成二维码/审核通过/审核驳回）
--       其他菜单页全量按钮
INSERT INTO sys_role_resource (role_id, resource_id) VALUES
(5, 1), (5, 6), (5, 8), (5, 10),
-- 父级菜单节点（前端路由渲染需要）
...
(5, 401), (5, 402), (5, 404),
-- 订单管理页按钮
(5, 1102), (5, 1103), (5, 1106), (5, 1107), (5, 1108),
(5, 1110), (5, 1112), (5, 1113), (5, 1117),
-- 工单页按钮
(5, 1201), (5, 1202), (5, 1205), (5, 1206), (5, 1207), (5, 1210), (5, 1211),
-- 其他菜单页全量按钮（科室/医生/机构/部门/项目/产品/注册证/医院范围模板/账户/角色）
(5, 1014), (5, 1015), (5, 1016), (5, 1017),
(5, 1018), (5, 1019), (5, 1020), (5, 1021),
(5, 1026), (5, 1027), (5, 1028), (5, 1029),
(5, 1030), (5, 1031), (5, 1032), (5, 1033),
(5, 1034), (5, 1035), (5, 1036), (5, 1037),
(5, 1038), (5, 1039), (5, 1040), (5, 1041),
(5, 1042), (5, 1043), (5, 1044), (5, 1045),
(5, 1022), (5, 1023), (5, 1024), (5, 1025),
-- 角色管理按钮（新建/编辑/状态/删除/配置权限）
(5, 1005), (5, 1006), (5, 1007), (5, 1008), (5, 1009);
...
(6, 1), (6, 2), (6, 6), (6, 10),
(6, 102),
(6, 1202), (6, 1203), (6, 1204), (6, 1205), (6, 1206), (6, 1207), (6, 1208), (6, 1209);

-- 设计师管理员（role_id=7）
-- 菜单：同设计师 + 项目管理 + 产品管理 + 统计报表
-- 按钮：工单页（导出记录/查看详情/图纸指令单预览/影像在线预览/生成二维码/审核通过/审核驳回）
--       项目管理/产品管理全量按钮
--       订单管理页（订单列表Tab/批量导出/查看详情/影像调阅/修改历史）
INSERT INTO sys_role_resource (role_id, resource_id) VALUES
(7, 1), (7, 2), (7, 4), (7, 6), (7, 8), (7, 10),
(7, 101), (7, 102), (7, 303), (7, 304),
-- 订单管理页按钮
(7, 1102), (7, 1106), (7, 1107), (7, 1108), (7, 1110),
-- 工单页按钮
(7, 1201), (7, 1202), (7, 1205), (7, 1206), (7, 1207), (7, 1210), (7, 1211),
-- 项目/产品全量按钮
(7, 1034), (7, 1035), (7, 1036), (7, 1037),
(7, 1038), (7, 1039), (7, 1040), (7, 1041);
...
-- 生产管理员（role_id=9）
-- 菜单：同生产员 + 仓储管理 + 物料管理 + 统计报表
-- 按钮：物料管理全量按钮
INSERT INTO sys_role_resource (role_id, resource_id) VALUES
(9, 1), (9, 2), (9, 4), (9, 6), (9, 8), (9, 10),
(9, 103), (9, 105), (9, 305),
(9, 1042), (9, 1043), (9, 1044), (9, 1045);

-- 质检员（role_id=10）
-- 菜单：数据概览、订单管理、质检管理、资料管理、个人中心
-- 按钮：订单管理页（订单列表Tab/查看详情/影像调阅/修改历史）
INSERT INTO sys_role_resource (role_id, resource_id) VALUES
(10, 1), (10, 2), (10, 6), (10, 10),
(10, 101), (10, 104),
(10, 1102), (10, 1107), (10, 1108), (10, 1110);
