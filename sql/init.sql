...
(5, 1, '1.4', '服务商', 'service_provider', 2, 4, 1);
...
-- 生产流转卡列表默认列配置
INSERT INTO sys_config (config_key, config_name, config_value, config_type, config_group, config_desc, is_system, is_public, sort, status)
VALUES ('production.column.config', '生产流转卡列表默认列配置', '{"module":"production","columns":[{"field":"isUrgent","label":"加急","visible":true,"sort":1,"width":70,"fixed":null},{"field":"designPackageCode","label":"数据包编号","visible":true,"sort":2,"width":150,"fixed":null},{"field":"productionBatchNo","label":"生产批号","visible":true,"sort":3,"width":150,"fixed":null},{"field":"orderCode","label":"订单流水号","visible":true,"sort":4,"width":160,"fixed":null},{"field":"currentProcessName","label":"当前工序","visible":true,"sort":5,"width":120,"fixed":null},{"field":"statusName","label":"状态","visible":true,"sort":6,"width":120,"fixed":null},{"field":"orderTypeName","label":"订单类型","visible":true,"sort":7,"width":110,"fixed":null},{"field":"totalProductCount","label":"产品数量","visible":true,"sort":8,"width":90,"fixed":null},{"field":"hospitalName","label":"医院名称","visible":true,"sort":9,"width":180,"fixed":null},{"field":"hospitalDeptName","label":"科室名称","visible":true,"sort":10,"width":100,"fixed":null},{"field":"doctorName","label":"医生姓名","visible":true,"sort":11,"width":100,"fixed":null},{"field":"patientName","label":"患者姓名","visible":true,"sort":12,"width":100,"fixed":null},{"field":"isPostal","label":"是否邮寄","visible":true,"sort":13,"width":80,"fixed":null},{"field":"expectedDeliveryDate","label":"期望交付时间","visible":true,"sort":14,"width":160,"fixed":null},{"field":"printStartTime","label":"生产开始时间","visible":true,"sort":15,"width":160,"fixed":null},{"field":"postProcessingEndTime","label":"生产结束时间","visible":true,"sort":16,"width":160,"fixed":null},{"field":"orgName","label":"机构名称","visible":true,"sort":17,"width":150,"fixed":null},{"field":"createTime","label":"创建时间","visible":true,"sort":18,"width":160,"fixed":null},{"field":"action","label":"操作","visible":true,"sort":19,"width":150,"fixed":"right"}]}', 'json', 'system', '生产流转卡列表默认显示的列（JSON格式）', 1, 0, 14, 1);

-- 质检列表默认列配置
INSERT INTO sys_config (config_key, config_name, config_value, config_type, config_group, config_desc, is_system, is_public, sort, status)
VALUES ('quality.column.config', '质检列表默认列配置', '{"module":"quality","columns":[{"field":"recordNo","label":"流转卡编号","visible":true,"sort":1,"width":160,"fixed":null},{"field":"designPackageCode","label":"数据包编号","visible":true,"sort":2,"width":160,"fixed":null},{"field":"productionBatchNo","label":"生产批号","visible":true,"sort":3,"width":140,"fixed":null},{"field":"orderCode","label":"订单号","visible":true,"sort":4,"width":130,"fixed":null},{"field":"hospitalName","label":"医院名称","visible":true,"sort":5,"width":130,"fixed":null},{"field":"hospitalDeptName","label":"科室","visible":true,"sort":6,"width":110,"fixed":null},{"field":"doctorName","label":"医生","visible":true,"sort":7,"width":90,"fixed":null},{"field":"patientName","label":"患者","visible":true,"sort":8,"width":90,"fixed":null},{"field":"isUrgent","label":"加急","visible":true,"sort":9,"width":65,"fixed":null},{"field":"isPostal","label":"邮寄","visible":true,"sort":10,"width":65,"fixed":null},{"field":"expectedDeliveryDate","label":"期望交付","visible":true,"sort":11,"width":110,"fixed":null},{"field":"orgName","label":"机构","visible":true,"sort":12,"width":110,"fixed":null},{"field":"totalProductCount","label":"产品数","visible":true,"sort":13,"width":70,"fixed":null},{"field":"qualifiedCount","label":"合格","visible":true,"sort":14,"width":60,"fixed":null},{"field":"unqualifiedCount","label":"不合格","visible":true,"sort":15,"width":70,"fixed":null},{"field":"pendingCount","label":"待检","visible":true,"sort":16,"width":60,"fixed":null},{"field":"status","label":"状态","visible":true,"sort":17,"width":100,"fixed":null},{"field":"createTime","label":"创建时间","visible":true,"sort":18,"width":160,"fixed":null},{"field":"action","label":"操作","visible":true,"sort":19,"width":170,"fixed":"right"}]}', 'json', 'system', '质检列表默认显示的列（JSON格式）', 1, 0, 15, 1);

-- 仓储列表默认列配置
INSERT INTO sys_config (config_key, config_name, config_value, config_type, config_group, config_desc, is_system, is_public, sort, status)
VALUES ('warehouse.column.config', '仓储列表默认列配置', '{"module":"warehouse","columns":[{"field":"recordNo","label":"流转卡编号","visible":true,"sort":1,"width":160,"fixed":null},{"field":"designPackageCode","label":"数据包编号","visible":true,"sort":2,"width":160,"fixed":null},{"field":"status","label":"状态","visible":true,"sort":3,"width":90,"fixed":null},{"field":"productionBatchNo","label":"生产批号","visible":true,"sort":4,"width":140,"fixed":null},{"field":"orderNo","label":"订单号","visible":true,"sort":5,"width":130,"fixed":null},{"field":"hospitalName","label":"医院名称","visible":true,"sort":6,"width":130,"fixed":null},{"field":"hospitalDeptName","label":"科室","visible":true,"sort":7,"width":110,"fixed":null},{"field":"doctorName","label":"医生","visible":true,"sort":8,"width":90,"fixed":null},{"field":"patientName","label":"患者","visible":true,"sort":9,"width":90,"fixed":null},{"field":"isUrgent","label":"加急","visible":true,"sort":10,"width":65,"fixed":null},{"field":"isPostal","label":"邮寄","visible":true,"sort":11,"width":65,"fixed":null},{"field":"expectedDeliveryDate","label":"期望交付","visible":true,"sort":12,"width":110,"fixed":null},{"field":"totalCount","label":"产品总数","visible":true,"sort":13,"width":80,"fixed":null},{"field":"warehouseCountSummary","label":"待入/已入/已出","visible":true,"sort":14,"width":130,"fixed":null},{"field":"earliestInTime","label":"最早入库","visible":true,"sort":15,"width":160,"fixed":null},{"field":"latestOutTime","label":"最晚出库","visible":true,"sort":16,"width":160,"fixed":null},{"field":"action","label":"操作","visible":true,"sort":17,"width":140,"fixed":"right"}]}', 'json', 'system', '仓储列表默认显示的列（JSON格式）', 1, 0, 16, 1);
...
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1123, 101, '我的申请Tab', 'order:TabMyCancel', 3, null, null, null, null, 23, 1, 1, null, '2026-07-17 00:00:00', '2026-07-17 00:00:00', null, null, 0);
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1124, 101, '待审核申请列表', 'order:CancelApply', 3, null, null, null, null, 24, 1, 1, null, '2026-07-17 00:00:00', '2026-07-17 00:00:00', null, null, 0);
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1125, 101, '审核通过', 'order:CancelApprove', 3, null, null, null, null, 25, 1, 1, null, '2026-07-17 00:00:00', '2026-07-17 00:00:00', null, null, 0);
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1126, 101, '审核驳回', 'order:CancelReject', 3, null, null, null, null, 26, 1, 1, null, '2026-07-17 00:00:00', '2026-07-17 00:00:00', null, null, 0);
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1127, 101, '取消申请历史', 'order:CancelHistory', 3, null, null, null, null, 27, 1, 1, null, '2026-07-17 00:00:00', '2026-07-17 00:00:00', null, null, 0);
...
INSERT INTO yigongbao.sys_resource (id, parent_id, resource_name, resource_code, resource_type, icon, path, component, redirect, sort, visible, status, remark, create_time, update_time, create_by, update_by, is_deleted) VALUES (1314, 103, '强制完成打印', 'manufacture:ForceCompletePrint', 3, null, null, null, null, 14, 1, 1, '设备未推送打印完成消息时由生产管理员进行异常补偿', '2026-09-03 00:00:00', '2026-09-03 00:00:00', null, null, 0);
...
(3,  '区域管理员',   'regional-manager',    '管理主所属机构及账户额外分配机构的全部订单',                   '6.2', 'user_orgs', 1),
(13, '业务员（服务）', 'salesman-self',     '企业内部业务员，负责订单开拓、客户维护，只能看自己关联医院的数据', '6.1', 'hospitals', 1),
-- 设计线角色（企业内部）
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1218, 1, 1123);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1219, 1, 1124);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1220, 1, 1125);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1221, 1, 1126);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1222, 1, 1127);
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1223, 2, 1123);
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1224, 4, 1210);
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1225, 5, 1124);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1226, 5, 1125);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1227, 5, 1126);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1228, 5, 1127);
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1215, 7, 1314);
...
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1229, 13, 1113);
INSERT INTO yigongbao.sys_role_resource (id, role_id, resource_id) VALUES (1230, 13, 1123);
